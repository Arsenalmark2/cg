...
void display(void) 
{ 
 char string[]="STEP 1: DRAW POLYGON USING THE \"MOUSE-CLICKS\" AND PRESS \"ENTER KEY\" TO DRAW THE FINAL EDGE"; 
...
{ 
 char string[]="STEP 2:PICK DERISED COLOUR FROM THE DESIGNED COLOUR PANEL"; 
switch(key) 
{ 
...
char string[]="STEP 3: CLICK INSIDE THE POLYGON TO FILL YOUR DESIRED COLOUR"; 
glColor3f(1.0,1.0,1.0); 
